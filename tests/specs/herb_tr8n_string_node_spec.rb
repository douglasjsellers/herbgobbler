...
describe HerbTr8nStringNode do
  ...
  it "should escape new line character" do
    s = "please escape \n this character"
    string_node = HerbTr8nStringNode.new( s )
    string_node.text_value.should == "please escape {br} this character"
  ...
  it "should escape two \n characters in a row" do
    s = "please escape \n\n this character"
    string_node = HerbTr8nStringNode.new( s )
    string_node.text_value.should == "please escape {br}{br} this character"
  ...
  it "should escape \n characters book ending a string" do
    ...
    string_node = HerbTr8nStringNode.new( s )
    string_node.text_value.should == "{br}please escape this character{br}"
  end
  ...
  it "should escape all special characters" do
    ...
    string_node = HerbTr8nStringNode.new( s )
    string_node.text_value.should == "please escape {br} {ndash} {mdash} {iexcl} {iquest} {quot} {ldquo} {rdquo} {lsquo} {rsquo} {laquo} {raquo} {nbsp} this character"
